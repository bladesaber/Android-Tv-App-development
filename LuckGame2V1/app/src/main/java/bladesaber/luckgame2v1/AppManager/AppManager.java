package bladesaber.luckgame2v1.AppManager;
...
public class AppManager {
    ...
    public static String AppManager_GetMac(Context context){
        ...
        if (!macAddress.equals("020000000002")) {
            //Toast.makeText(context,"MAC地址 获取成功 "+macAddress ,Toast.LENGTH_LONG).show();
            return macAddress.replace(":", "");
        }else {
            //Toast.makeText(context,"MAC地址 获取失败 使用 ANDROID ID "+android_id,Toast.LENGTH_LONG).show();
            return android_id;
        }
    }
    */
