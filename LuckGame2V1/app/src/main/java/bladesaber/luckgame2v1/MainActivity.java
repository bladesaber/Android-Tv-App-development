...
import bladesaber.luckgame2v1.ERCoddeActivity.ERCodeActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CrashReport.initCrashReport(getApplicationContext(), "04dd3d0344", false);
    ...
    private void Check_RegisterStatus(String BackEnd_Register_State,Map<String,Object> JsonMap){
        ...
        GlobalSignManager.Status = BackEnd_Register_State;
