...
public class ViewPagerManager2 {
    ...
    ViewPagerManager2(Context mycontext, ViewPager myviewPager, ImageView mybackground){
        ...
        viewPager.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                if ( ( Image_Item_List_Buffer.size() != 0 ) && ( currentPosition == 0 ) ){
                    ...
                    Anto = 0;
                    Handle_Sub(Image_Item_List_Buffer);
    ...
    private void Image_List_is1(List<ImageItem> image_List){
        ...
        if (view_list.size()>1){
            ...
            view_list.get(0).SetImage(context,image_List.get(0).getUrl());
            viewPagerAdapter.notifyDataSetChanged();
            viewPager.setCurrentItem(0);
        }
    ...
    private void Image_List_Bigger1(List<ImageItem> image_List){
        ...
        if (image_List.size()>(view_list.size()-2)) {
            System.out.println("Image_List_Bigger1-add");
            Handle_Add(image_List);
        }
        if (image_List.size()<(view_list.size()-2)){
            System.out.println("Image_List_Bigger1-sub");
            Image_Item_List_Buffer.addAll(image_List);

            System.out.println("Image_List_Bigger1.currentPosition: "+currentPosition);
            System.out.println("Image_List_Bigger1.view_list.size: "+view_list.size());
