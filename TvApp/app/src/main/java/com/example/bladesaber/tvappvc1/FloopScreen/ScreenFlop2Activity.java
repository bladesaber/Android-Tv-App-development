...
public class ScreenFlop2Activity extends AppCompatActivity {
                ...
                case TIME_CLICK:
                    ...
                    if (Time==0){
                        if (Lock == 0) {
                            ...
                            if (intent != null) {
                                System.out.println("ScreenFlop2Activity.getWorking: " + PagerViewActivity.floopScreenManager.getWorking());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.floop_screen2);
    ...
    private void Init(){
        Image = (ImageView) findViewById(R.id.screen_floop_image_Image);
        ...
        Icon = (ImageView) findViewById(R.id.screen_floop_image_playerIcon);
        Picasso.with(getBaseContext())
                .load(playerIcon_Url)
                .memoryPolicy(MemoryPolicy.NO_CACHE,MemoryPolicy.NO_STORE)
                .networkPolicy(NetworkPolicy.NO_CACHE,NetworkPolicy.NO_STORE)
        ...
        Name = (TextView) findViewById(R.id.screen_floop_image_playername);
        Name.setText(playerName);

        ShowText = (TextView) findViewById(R.id.floop_screen_image_TextView);
        ShowText.setText(show_Text);

        TimeClick = (TextView) findViewById(R.id.screen_floop_image_TimeClick);
        TimeClick.setText(String.valueOf(Time));
