...
/**
 * Created by bladesaber on 2018/4/18.
 */
...
public class GlobalFunctionManager {
    ...
    public static void Post_AppStatus(String Mac,String Status) {
        ...
        PostThread postThread = new PostThread(GlobalSignManager.App_Status_Url,jsonObject);
        postThread.start();
    }
